    ...
    return {
        ...
        "bot": {
            "long": {
                ...
                "hedge_roc_period": 1,
                "hedge_max_operations_window": 3,
                "hedge_operation_window_minutes": 15,
                "hedge_enable_incremental_adjustment": True,
                "hedge_size_tolerance_pct": 0.005,
                "twe_exposure_risky_threshold": 0.0,
                "twe_exposure_risky_offload": 0.0,
                "close_grid_markup_start_risky_offload_pct": 0.0,
            },
            "short": {
                "close_grid_markup_end": 0.0089,
                "close_grid_markup_start": 0.0344,
        ...
        "optimize": {
            "bounds": {
                ...
                "long_hedge_enabled": [1, 1],
                "long_hedge_atr_period": [10, 20],
                "long_hedge_distance_atr_trigger": [2.0, 5.0],
                "long_hedge_stop_loss_atr": [1.0, 3.0],
                "long_hedge_breakeven_atr": [0.5, 2.0],
                "long_hedge_min_exposure_pct": [0.80, 0.99],
                "long_hedge_min_exposure_pct_to_close": [0.70, 0.95],
                "long_hedge_entry_mode": ["atr_only", "atr_only"],
                "long_hedge_exit_mode": ["standard", "standard"],
                "long_hedge_volatility_method": ["std", "std"],
                "long_hedge_volatility_period": [10, 30],
                "long_hedge_high_volatility_threshold": [0.01, 0.05],
                "long_hedge_normal_volatility_threshold": [0.005, 0.02],
                "long_hedge_roc_period": [1, 5],
                "long_hedge_max_operations_window": [1, 5],
                "long_hedge_operation_window_minutes": [10, 30],
                "long_hedge_enable_incremental_adjustment": [1, 1],
                "long_hedge_size_tolerance_pct": [0.001, 0.01],
                "long_twe_exposure_risky_threshold": [0, 0],
                "long_twe_exposure_risky_offload": [0, 0],
                "long_close_grid_markup_start_risky_offload_pct": [0, 0],
                ...
                "short_hedge_enabled": [0, 0],
                "short_hedge_atr_period": [14, 14],
                "short_hedge_distance_atr_trigger": [3.0, 3.0],
                "short_hedge_stop_loss_atr": [2.0, 2.0],
                "short_hedge_breakeven_atr": [1.0, 1.0],
                "short_hedge_min_exposure_pct": [0.95, 0.95],
                "short_hedge_min_exposure_pct_to_close": [0.90, 0.90],
                "short_hedge_entry_mode": ["atr_only", "atr_only"],
                "short_hedge_exit_mode": ["standard", "standard"],
                "short_hedge_volatility_method": ["std", "std"],
                "short_hedge_volatility_period": [20, 20],
                "short_hedge_high_volatility_threshold": [0.02, 0.02],
                "short_hedge_normal_volatility_threshold": [0.01, 0.01],
                "short_hedge_roc_period": [1, 1],
                "short_hedge_max_operations_window": [3, 3],
                "short_hedge_operation_window_minutes": [15, 15],
                "short_hedge_enable_incremental_adjustment": [1, 1],
                "short_hedge_size_tolerance_pct": [0.005, 0.005],
                "short_twe_exposure_risky_threshold": [0, 0],
                "short_twe_exposure_risky_offload": [0, 0],
                "short_close_grid_markup_start_risky_offload_pct": [0, 0],
            },
